    ...
    <div className="tulips-wrapper">
      <div className="tulips-container">
        ...
        <div className="flowers">
          {messageLines && (
            <div className="tulips-message">
              <span className="message-desktop">{messageLines.join(" ")}</span>
              <span className="message-mobile">
          ...
          {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div key={i} className={`long-g long-g--${i}`}>
              ...
              <div className="grow-ans" style={{ '--d': `${3.2 + i * 0.2}s` } as React.CSSProperties}>
